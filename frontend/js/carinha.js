...
cartBtn?.addEventListener('click', (e) => {
    e.stopPropagation(); // Impede event bubbling desnecessário
...
confirmPaymentBtn?.addEventListener('click', () => {
    ...
    // Validação: 9 dígitos + prefixos válidos
